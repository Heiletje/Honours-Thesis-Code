...
# resExp = optimize(E_Calibrate, log.(E_θ₀), Optim.Options(show_trace = true, iterations = 2500))
...
resExp = optimize(E_Calibrate, log.(E_θ₁), Optim.Options(show_trace = true, iterations = 500))
parExp = exp.(Optim.minimizer(resExp))
save("Parameters/Prelim/MHP_ParametersExp1.jld", "parExp", parExp)

#E_θ2 = load("Parameters/Prelim/MHP_ParametersExp1.jld")["parExp"]
